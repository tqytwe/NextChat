...
import { compressMobileImage, removeMobileImage } from "../client/mobile-image";

export const compressImage = compressMobileImage;
...
export const removeImage = removeMobileImage;
