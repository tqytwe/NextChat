...
export enum Path {
  ...
  AccountSystemSettings = "/account/system-settings",
  AccountAppearance = "/account/system-settings/appearance",
  AccountLanguage = "/account/system-settings/language",
  AccountPermissions = "/account/system-settings/permissions",
  AccountWebOpenMode = "/account/system-settings/web-open-mode",
